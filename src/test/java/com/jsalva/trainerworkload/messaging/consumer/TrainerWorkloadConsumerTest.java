...
class TrainerWorkloadConsumerTest {
    ...
    void shouldProcessAddMessageAndCreateNewTrainerWorkload() {
        ...
        await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            assertThat(trainer.get().getIsActive()).isTrue();

            // Verify year was created
            assertThat(trainer.get().getYears()).hasSize(1);
            TrainerMonthlyWorkload.YearSummary yearSummary = trainer.get().getYears().getFirst();
            assertThat(yearSummary.getYear()).isEqualTo(2024);
            ...
            assertThat(monthSummary.getTotalWorkload()).isEqualTo(60);
        });
    }
    ...
    void shouldProcessAddMessageAndIncrementExistingWorkload() {
        ...
        await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            Optional<TrainerMonthlyWorkload> workload = trainerWorkloadRepository.findByUsername(updatedTrainer.get().getUsername());
            assertThat(workload).isPresent();
            assertThat(workload.get().getYears().getFirst().getMonths().getFirst().getTotalWorkload()).isEqualTo(160); // 100 + 60
        });
    }
    ...
    void shouldProcessDeleteMessageAndDecrementWorkload() {
        ...
        TrainerMonthlyWorkload.MonthSummary monthSummary = new TrainerMonthlyWorkload.MonthSummary();
        monthSummary.setMonth(2);
        monthSummary.setTotalWorkload(100); // given 100 minutes in workload
        yearSummary.getMonths().add(monthSummary);
        ...
        await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            Optional<TrainerMonthlyWorkload> workload = trainerWorkloadRepository.findByUsername(updatedTrainer.get().getUsername());
            assertThat(workload).isPresent();
            assertThat(workload.get().getYears().getFirst().getMonths().getFirst().getTotalWorkload()).isEqualTo(70); // 100 - 30
        });
    }
    ...
    void shouldProcessDeleteMessageAndRemoveWorkloadWhenReachesZero() {
        ...
        TrainerMonthlyWorkload.MonthSummary monthSummary = new TrainerMonthlyWorkload.MonthSummary();
        monthSummary.setMonth(2);
        monthSummary.setTotalWorkload(60); // given 100 minutes in workload
        yearSummary.getMonths().add(monthSummary);
        ...
        await().atMost(5, TimeUnit.SECONDS).untilAsserted(() -> {
            ...
            Optional<TrainerMonthlyWorkload> workload = trainerWorkloadRepository.findByUsername(updatedTrainer.get().getUsername());
            assertThat(workload).isPresent();
            assertThat(workload.get().getYears()).isEmpty();
        });
    }
